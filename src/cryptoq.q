...
/ @param Msg [String]
/ @return Hexadecimal
sha256:{[Msg] sha256_start Msg};

/ Returns SHA512 Hash of Msg 
/ @param Msg [String]
/ @return Hexadecimal
sha512:{[Msg] sha512_start Msg};
...
sha512_start:{[Msg]
  ...
  i:0; hc:.cryptoq_binary.hex_to_bin@'H_512;
  ind : til 1024;
...
sha512_cal_hvals:{[Words;hc;i]
   a:hc 0;b:hc 1;c:hc 2 ;d:hc 3;e:hc 4;f:hc 5;g:hc 6;h:hc 7;
   t1:(.cryptoq_binary.bin_modulo_64/)(h;s512_sum2[e];sch[e;f;g];.cryptoq_binary.hex_to_bin K_512[i];Words[i]);
